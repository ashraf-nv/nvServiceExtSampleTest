...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of nvServiceExtSampleTest.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'nvServiceExtSampleTest/Classes/**/*'
  
  # s.resource_bundles = {
  #   'nvServiceExtSampleTest' => ['nvServiceExtSampleTest/Assets/*.png']
  # }
